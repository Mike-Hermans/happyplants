...
from screens import SplashScreen as SSplash, TestScreen as STest, MainScreen as SMain
...
class Main(Tk):
    ...
    def initialize_frames(self, container):
        application_frames = [SSplash.SplashScreen, STest.TestScreen, SMain.MainScreen]
...
# Collects all images that are needed for the current page and returns them in a list.
